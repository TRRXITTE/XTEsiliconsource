...
class InternalStats {
 public:
  ...
  enum InternalDBStatsType {
    INTERNAL_WAL_FILE_BYTES,
    INTERNAL_WAL_FILE_SYNCED,
    INTERNAL_BYTES_WRITTEN,
    INTERNAL_NUMBER_KEYS_WRITTEN,
    INTERNAL_WRITE_DONE_BY_OTHER,
    INTERNAL_WRITE_DONE_BY_SELF,
    INTERNAL_WRITE_WITH_WAL,
    WRITE_STALL_MICROS,
